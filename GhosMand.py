...
for i in range(3):
    ...
    if (pwd == RIZZX+):
        ...
        time.sleep(5)
        print("[V1] Valid |Password| RIZZX+ [V1]\n")
        continue
time.sleep(2)
print("[V1] Welcome To Tools Rizz by RIZZX+ [V1]")
time.sleep(2)
nicknm = "RIZZX+"
...
\033[35m                ║\033[32m                                               \033[35m║
\033[35m                ║\033[32m             ? - Help menu #RIZZX+          \033[35m║
...
\033[35m                ╔═══════════════════════════════════════════════╗
\033[35m                ║\033[32m- - - - - - - Joker vF By \033[36m@RIZZX+ \033[35m-- - - - -║
\033[35m                ║\033[32m- - - - - - - Recoded By \033[36mRIZZX+\033[35m - -- - - - -║
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;Joker. | number_powered: [{}] | Discord : RIZZX+ \x07".format (bots))
